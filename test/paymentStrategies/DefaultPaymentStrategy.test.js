import {DefaultPaymentStrategy} from "../../src/paymentStrategies";
import FreeCallPaymentStrategy from '../../src/paymentStrategies/FreeCallPaymentStrategy';
...
jest.mock('../../src/paymentStrategies/FreeCallPaymentStrategy');
jest.mock('../../src/paymentStrategies/PrepaidPaymentStrategy');
jest.mock('../../src/paymentStrategies/PaidCallPaymentStrategy');
